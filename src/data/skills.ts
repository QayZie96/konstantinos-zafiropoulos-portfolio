...
export const skills = [
    ...
    },
    {
        ...
        umbrella: "operations-ecommerce",
        description: "Monitoring marketplace standards and protecting service quality across 23,000+ items sold, with zero negative feedback on the final live profile.",
        projects: ["rocketeers", "operations"],
    },
    {
    ...
    },
    {
        ...
        projects: ["repricing", "aiOutreach", "chess"],
    },
    {
        id: "data-quality",
        label: "Data Quality",
    ...
    },
    {
        ...
        umbrella: "excel-vba-analytics",
        description: "Designing readable charts and summary views for marketplace performance, financial reporting, workout progression, and chess analysis.",
        projects: ["rocketeers", "finance", "gym", "chess"],
    },
    {
        id: "dashboards",
        label: "Dashboard Design",
        umbrella: "excel-vba-analytics",
        description: "Creating interactive dashboards and operational reporting views for fast, reliable interpretation.",
        projects: ["gym", "finance", "chess"],
    },
    {
    ...
    },
    {
        ...
        umbrella: "excel-vba-analytics",
        description: "Turning detailed marketplace, financial, and workout records into concise summaries and decision-oriented views.",
        projects: ["rocketeers", "finance", "gym"],
    },
    {
        id: "excel-automation",
    ...
    },
    {
        ...
        description: "Building modular data workflows for job automation and large-scale chess analysis, from transformation through validated outputs.",
        projects: ["aiOutreach", "chess"],
    },
    {
        id: "sql",
        label: "SQL",
        umbrella: "python-data-web",
        description: "Writing analytical queries that aggregate chess outcomes by rating gap, opening, player colour, rating band, and speed category.",
        projects: ["chess"],
    },
    {
        id: "duckdb",
        label: "DuckDB",
        umbrella: "python-data-web",
        description: "Using DuckDB as the analytical SQL engine for efficient aggregation over the processed chess dataset.",
        projects: ["chess"],
    },
    {
        id: "power-bi",
        label: "Power BI",
        umbrella: "excel-vba-analytics",
        description: "Building and validating interactive report pages for rating upsets and opening-performance exploration.",
        projects: ["chess"],
    },
    {
        id: "data-analysis",
        label: "Data Analysis",
        umbrella: "excel-vba-analytics",
        description: "Defining analytical populations, calculating weighted rates, testing comparisons, and communicating findings with explicit limitations.",
        projects: ["rocketeers", "finance", "gym", "chess"],
    },
    {
        ...
        umbrella: "excel-vba-analytics",
        description: "Exploring a 500,000-game Lichess sample to identify defensible rating-upset and opening-performance questions.",
        projects: ["chess"],
    },
    {
        id: "data-aggregation",
        ...
        umbrella: "excel-vba-analytics",
        description: "Aggregating numerator and denominator counts so filtered rates remain weighted and analytically correct.",
        projects: ["chess"],
    },
    {
